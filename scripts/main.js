...
async function getInputValue(){
  ...
  if(value === "help" || value === "Help"){
    ...
    trueValue(value);
    createText("<a href='cydia://url/https://cydia.saurik.com/api/share#?source=https://badaccess.dev/'>Add to Cydia</a>")
    createText("<a href='sileo://source/https://badaccess.dev/'>Add to Sileo</a>")
    createText("<a href='zbra://sources/add/https://badaccess.dev/'>Add to Zebra</a>")
    createText("<a href='installer://add/https://badaccess.dev/'>Add to Installer</a>")
  }
